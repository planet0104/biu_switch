...
fn main() -> ! {
    ...
    if let (Some(mut p), Some(cp)) = (pac::Peripherals::take(), Peripherals::take()) {
        ...
        loop {
            ...
            toggle_speaker_switch(&gpio_switch_speaker, &mut delay, &mut speaker_opend);
...
fn toggle_speaker_switch(pin: &mut PA6<Output<PushPull>>, delay:&mut Delay, speaker_opend:&mut bool){
