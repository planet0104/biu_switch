        ...
        loop {
            ...
            if let Ok(true) = gpio_button.is_low(){
                ...
                if ten_sec == 0{
                    ...
                    beep(&mut gpio_beep, &mut delay, ten_sec, None);
                }
            ...
            let elapsed_minutess = elapsed_millis/1000/60;
            if elapsed_millis >= delay_poweroff_minutes{
                power_off(beep_pin, &mut delay);
            }
        }
    }
