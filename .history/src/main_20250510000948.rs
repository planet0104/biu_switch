...
// use stm32_i2s_v12x::{driver::{DataFormat, I2sDriver, I2sDriverConfig}, marker::{Master, Philips, Receive}};
use stm32f4xx_hal::{self as hal, i2s::{stm32_i2s_v12x::{driver::{DataFormat, I2sDriver, I2sDriverConfig}, marker::{Master, Philips, Receive}}, I2s}, pac::SPI2};
...
fn main() -> ! {
    if let (Some(dp), Some(_cp)) = (
        ...
        let i2s2_config = I2sDriverConfig::new_master()
            ...
            .master_clock(true)
            .clock_polarity(stm32f4xx_hal::i2s::stm32_i2s_v12x::driver::ClockPolarity::IdleLow)
