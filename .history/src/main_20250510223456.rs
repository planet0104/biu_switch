...
use stm32f4xx_hal::{
    self as hal, gpio::{Input, Output, PA5}, i2s::{
        stm32_i2s_v12x::{
...
fn turnoff_speaker(pin: &mut PA5<Output>, delay:&stm32f4xx_hal::timer::Delay<stm32f4xx_hal::pac::TIM5, 1000000>, duration_ms: u32){
    // let _ = pin.lo
